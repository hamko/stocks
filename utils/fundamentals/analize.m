...
# 銘柄，PER妥当株価のσ，PBR妥当株価のσ，アナリスト人数，レーティング, PER妥当株価と現在との差の割合，PBR妥当株価と現在との差の割合
...
M_Expensive = flipud(sortrows(M_Expensive, 6));
...
save M_Market.dat M_Market
save M_GoodMarket.dat M_GoodMarket
